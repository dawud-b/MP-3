...
int main(int argc, char** argv) {
    ...
    if (argc < 2) {
        std::cout << "./sentry <path to image folder containing BIMG_xyz.BIN files. path can be finicky> <optional: x from center that is considered sufficiently centered> <optional: y from center that is considered sufficiently centered> <optional: added delay in loop> <optional: T for verbose mode>" << std::endl;
        return 1;
    }
